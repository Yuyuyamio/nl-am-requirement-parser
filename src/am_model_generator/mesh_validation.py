...
MESH_VALIDATION_FILENAME = "mesh_validation.json"
...
def validate_m2_mesh(
    ...
    if (
        receipt.get("local_file")
        != model_filename
    ):
        raise M2ProviderError(
            "M2_MESH_MODEL_REFERENCE_MISMATCH",
            "Manifest与Artifact Receipt指向不同模型",
        )
