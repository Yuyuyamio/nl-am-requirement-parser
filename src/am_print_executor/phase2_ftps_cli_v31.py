...
from .ftps_probe_v31 import Gate2Error, REQUEST_ID_DEFAULT, run_gate2


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="M4 Gate 2 v3.1: non-printable FTPS canary upload/download/SHA256/delete probe."
    )
