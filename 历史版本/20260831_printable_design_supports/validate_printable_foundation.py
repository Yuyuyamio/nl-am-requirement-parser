...
def main():
    ...
    process["layer_height"] = str(args.layer_height)
    if args.solid:
        # Bambu serializes Rectilinear as "zig-zag". "rectilinear" is a
        # different/unsupported sparse pattern and fails 100% validation.
        process.update(sparse_infill_density="100%", sparse_infill_pattern="zig-zag")
