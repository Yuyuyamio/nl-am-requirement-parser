...
_MANDATORY_FDM_CONTRACT = (
    ...
    "keep the intended upright pose, with feet or rump down; "
    "use continuous layer-supported geometry on a planar bottom; "
    "avoid long unsupported cantilever features; "
    "avoid isolated appendages beginning in free air; "
    "use thick rising roots under ears and overhangs; "
    "connect robust protrusions downward to body or base; "
    "keep the center of mass inside the flat footprint; "
    "preserve object identity and requested dimensions."
)
