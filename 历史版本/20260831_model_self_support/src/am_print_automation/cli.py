...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--allow-structural-geometry-changes", action="store_true",
                        help="Allow visible permanent bases/ribs and solid infill; strict final gates still apply")
